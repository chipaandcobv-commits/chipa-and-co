...
const initialConfigs = [
  ...
  },
  {
    key: 'pointsPerPeso',
    value: '1',
    description: 'Cantidad de puntos que se otorgan por cada peso gastado (1 = 1 peso = 1 punto)'
  },
  {
    key: 'pointsLimit',
    value: '150000',
    description: 'Límite máximo de puntos que puede acumular un usuario antes de mostrar advertencia'
  },
  {
    key: 'systemName',
    value: 'Chipa&Co',
  ...
  },
  {
    ...
    value: '1212',
    description: 'Clave de seguridad de 4 números para acceder al apartado de configuración (solo modificable desde base de datos)'
  }
];
...
async function initSystemConfig() {
  try {
    ...
    console.log('   3. La clave de seguridad (1212) solo se puede cambiar desde la base de datos');
